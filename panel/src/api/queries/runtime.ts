...
export const runtimeJobSchema = z.object({
  ...
  result: z.object({ summary: z.string(), blockers: z.array(z.string()), draft_id: z.string().nullable(), draft_revision: z.number().nullable(), proposal_id: z.string().nullable().optional(), preparation_error: z.string().nullable().optional(), published: z.literal(false), activation_blockers: z.array(z.string()) }).nullable(),
});
